...
mv "~/Library/MobileDevice/Provisioning Profiles/build_mac_pp.mobileprovision" "~/Library/MobileDevice/Provisioning Profiles/$build_mac_pp_uuid.mobileprovision"
